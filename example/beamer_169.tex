...
\logo{\includegraphics[height=0.07\paperheight]{/media/bagustris/bagus/Pictures/logo/jaist_logo-1.png}}
...
\column{.53\textwidth}
	\begin{figure} 
	\animategraphics[autoplay,loop, width=\textwidth]{10}{fig/rnn_anim-}{0}{201}
...
\item Proposed solution:Using LSTM algorithm to train valence, arousal and liking 
      ...
      number of acoustic and visual features.
\item Network architecture:\\
\includegraphics[width=2.3in]{/media/bagustris/atmaja/s3/mypaper/2018/avec2018/pict/lstm.eps}
\end{itemize}
\end{frame}
...
\end{table}
\column{.6\textwidth} 
\includegraphics[width=2.7in]{/media/bagustris/atmaja/s3/mypaper/2018/avec2018/pict/CCC_mono.png}
\end{columns}
\end{frame}
